...
from pt.utils.custom_utils import IMAGES_ROOT
from pt.utils.custom_dataset import CustomDataset_Idx
...
class CustomLearner(Learner):  
    ...
    def _create_datasets(self, fl_ctx: FLContext):
        ...
        if self.train_dataset is None or self.train_loader is None:
            ...
            self.train_dataset = CustomDataset_Idx(
                root=f'{IMAGES_ROOT}/train',
                data_idx=site_idx,
